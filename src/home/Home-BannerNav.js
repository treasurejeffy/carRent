        ...
        <section id="banner">
            <Container>
                <Navbar expand="lg" sticky="top" id="navbar" className="px-4">                            
                    <Navbar.Brand href="#home" ><span id="logo">GENU</span>HIRE</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" >
                        <Nav  id="links"  className="m-auto" >
                            ...
                            <Nav.Link href="/toutorial" title="AboutUs" className="navLinks">About Us</Nav.Link>
                        ...
                        <Nav  id="links"  className="m-auto" >
                            ...
                            <Nav.Link href="#/about" title="Africa" className="searchIcon"><GlobeEuropeAfrica/> </Nav.Link>                            
                            <Nav.Link href="#link" title="My Cart" className="ShoppingCart"  onClick={() => setShow(true)}><Cart2 className='ShoppingCartImg text-light'/><span className="myCartCounter">{myCart.length}</span> </Nav.Link>
                        </Nav>
                    </Navbar.Collapse>                
                </Navbar>
